...
const HeroInfo = (props:heroinfoprops) => {
  return (
    ...
    className={cn('grid grid-cols-1 md:grid-cols-3 w-[99%] mx-auto item-center justify-between h-[140vh] mt-5 md:h-[60vh] p-4 gap-8 md:gap-12 ',props.className)}>
      <div className='pt-0 md:pt-10 relative  p-4 rounded-lg shadow-xl flex flex-col items-start'>
      ...
      <div className='pt-0 md:pt-10  border  p-4 rounded-lg shadow-xl flex flex-col relative items-start'>
      ...
      <div className='pt-0 md:pt-10  border relative shadow-white p-4 rounded-lg shadow-lg flex flex-col items-start'>

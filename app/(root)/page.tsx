...
export default function Home() {
  return (
    <section className=" md:overflow-hidden md:object-contain">
      <article className="mt-4 md:mt-0 md:pt-8 md:w-[80%] mx-auto">
        <ImageWithText
          imageurl={
            "https://l8yhwwsvkn8vkuaa.public.blob.vercel-storage.com/hero-9WNAVami4Ilsgq7QySTgyuNnsth4tO.jpg"
          }
          className="p-4 md:p-0 md:flex  flex-cols-reverse md:items-center md:justify-center gap-8 "
          title="Kente Mall"
